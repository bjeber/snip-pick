// Generated by `npm run auth:generate` (better-auth CLI) — do not edit by hand.
//
// One hand-applied fix survives regeneration only if you re-apply it: the CLI emits
// `clientCredentialsScopes: text(...).array().default()`, an argument-less `.default()` that does
// not type-check and produced no DEFAULT in the migration. It is written as a plain `.array()`
// below. Re-check this line after regenerating.
